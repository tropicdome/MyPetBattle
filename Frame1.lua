...
function Frame1Panel_Close()
	...
	-- PRE-COMBAT
	MPB_CONFIG_PRE_COMBAT_ATTEMPT_STRONGEST_RANDOM_TEAM = CheckButton15:GetChecked()
		
	-- COMBAT
	MPB_CONFIG_COMBAT_SWAP_PET_HEALTH_THRESHOLD = tonumber(EditBox_swap_pet_health_threshold:GetText()) / 100

	-- POST-COMBAT
	MPB_CONFIG_POST_COMBAT_USE_REVIVE_BATTLE_PETS_AFTER_COMBAT = CheckButton12:GetChecked()
	MPB_CONFIG_POST_COMBAT_USE_BATTLE_PET_BANDAGE_AFTER_COMBAT = CheckButton14:GetChecked()
	MPB_CONFIG_POST_COMBAT_AUTOMATIC_NEW_RANDOM_TEAM_AFTER_COMBAT = CheckButton11:GetChecked()
	MPB_CONFIG_POST_COMBAT_AUTO_REPLACE_25 = CheckButton25:GetChecked()
	-- MISC	
